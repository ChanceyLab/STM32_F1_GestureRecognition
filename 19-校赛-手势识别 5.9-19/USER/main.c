...
{
	//全局变量a1,a2储存前后的值
	static u8 a11=0,a22=0,a33=0;//标志位
	led1=1;led2=1;led3=1;led4=0;led5=1;//模式四
	data_process();
	if(val_sum<=100 && a11==0 && a22==0 && a33==0)//默认归中
	{
		dj_vs();point=0;
		led11=1;led22=1;led33=1;led44=1;led55=0;
	}
	if(val_sum>100 && a11==0 && a22==0 && a33==0)//第一次检测到手
	{
		delay(5);	
		a1=data_process();
	...
	if(val_sum<=100 && a11==1 && a22==0 && a33==0)//第一次第二次空挡
	{
		delay(2);	
		a11=1;a33=1;
		led11=1;led22=1;led33=0;led44=0;led55=0;
	}
	if(val_sum>100 && a11==1 && a22==0 && a33==1)//第二次监测到手
	{
		delay(5);	
		a2=data_process();
		...
		//{return 2;}//剪刀
		//{return 3;}//布
	if((val_sum<=100) && (a11==1) && (a22==1) && (a33==1) && (key_scan()==11))
	{
		if((a1==1 && a2==2) || (a1==2 && a2==3) || (a1==3 && a2==1) )
		{
			//前者胜！！！！！！！！！！！！！！！！
			one();a11=0;a22=0;a33=0;
			led11=1;led22=1;led33=1;led44=1;led55=1;
		}
		if(a1==a2)
		{
			//平局！！！！！！！！！！！！！！！！！
			two();a11=0;a22=0;a33=0;
			led11=1;led22=1;led33=1;led44=1;led55=1;
		}
		if(((a1==1) && (a2==3)) || ((a1==2) && (a2==1)) || ((a1==3) && (a2==2)))
		{
			//后者胜
			three();a11=0;a22=0;a33=0;
			led11=1;led22=1;led33=1;led44=1;led55=1;
		}
	}
}
...
void mode_learn()
{
	...
	learn_start:
	data_process();
	if(val_sum<=100 && b1==000 && b2==000)
	{
		dj_learn();point=0;
	}
	if(val_sum>100 && b1==000 && b2==000 && (key_scan()==22))//第一次训练
	{
		delay(1);
		one();b1=001;
	}
	if(val_sum<=100 && b1==001 && b2==000)//第一次训练空挡
	{
		b2=001;
	}
	if(val_sum>100 && b1==001 && b2==001 && (key_scan()==22))//第二次训练
	{
		delay(1);
		two();b1=011;	
	}
	if(val_sum<=100 && b1==011 && b2==001)//第er次训练空挡
	{
		b2=011;
	}
	if(val_sum>100 && b1==011 && b2==011 && (key_scan()==22))//第san次训练
	{
		delay(1);
		three();b1=111;	
	}
	if(val_sum<=100 && b1==111 && b2==011)//第san次训练空挡
	{
		b2=111;
	}
	if(val_sum<=100 && b1==111 && b2==111 && (key_scan()==22))//训练结束
	{
		//激光笔闪烁
		//三组
